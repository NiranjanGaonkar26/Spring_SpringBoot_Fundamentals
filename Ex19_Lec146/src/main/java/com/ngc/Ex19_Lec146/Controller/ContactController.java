package com.ngc.Ex19_Lec146.Controller;

import com.ngc.Ex19_Lec146.Model.Contact;
import com.ngc.Ex19_Lec146.Service.ContactService;
...
//    }
    ...
    public ModelAndView displayMessages(Model model){
        List<Contact> contactMsgs = contactService.getMsgsWithOpenStatus();
    ...
    public String closeMessage(@RequestParam int id, Authentication authentication){
        contactService.closeOpenMessage(id, authentication.getName());
